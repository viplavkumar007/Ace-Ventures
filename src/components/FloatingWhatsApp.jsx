      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-2xl border border-navy/8 p-4 mr-2 max-w-[200px]"
          >
            <p className="text-navy font-display font-bold text-sm">Chat on WhatsApp</p>
            <p className="text-navy/50 font-body text-xs mt-0.5">Instant response!</p>
          </motion.div>
        )}
      </AnimatePresence>
