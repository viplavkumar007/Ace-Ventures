  ...
  return (
    <ScrollReveal delay={index * 0.1}>
      <div className="rounded-2xl overflow-hidden shadow-xl border border-navy/8 bg-white">
        {/* Table header label */}
        <div className="px-6 py-4 flex items-center gap-3 bg-gradient-to-r from-navy to-[#0d3a6e]">
          ...
          <table className="w-full min-w-[520px]" role="table">
            ...
            <thead>
              <tr style={{ background: '#082544' }}>
                ...
                <th className="px-5 py-4 text-center text-white font-display font-bold text-sm tracking-wider uppercase whitespace-nowrap" style={{ borderLeft: '2px solid #FF7A1A' }}>
                  Innova Crysta
                </th>
              </tr>
            </thead>
            <tbody>
              {data.rows.map((row, ri) => (
                <motion.tr
                  ...
                  whileHover={{ backgroundColor: 'rgba(39, 216, 229, 0.06)' }}
                >
                  <td
                  ...
                  <td className="px-5 py-4 text-center" style={{ borderLeft: '2px solid rgba(255,122,26,0.2)' }}>
                    <button
                      onClick={() => handleBookWhatsApp(row.location, 'Innova Crysta', row.crysta)}
                      className="font-display font-bold text-orange text-lg hover:text-[#e06010] transition-colors duration-150"
                    >
                      {row.crysta}
                    </button>
                  </td>
...
export default function AirportFares() {
  return (
    <section id="airport-fares" className="py-20 md:py-28 bg-[#f7f9fc] relative overflow-hidden">
        ...
        <ScrollReveal delay={0.1}>
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            {[
              ...
              { label: 'Innova Crysta (7-Seater)', color: 'bg-orange', example: 'Toyota Crysta' },
            ].map((cat, i) => (
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-10 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-green-500 hover:bg-green-400 text-white font-display font-bold tracking-wide transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
            >
